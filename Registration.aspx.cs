    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    String str1 = "insert into registration( name, email, phoneno, password,usertype) values('" + txtname.Text + "','" + txtemail.Text + "','" + txtnum.Text + "','" + txtpass.Text + "','Account Holder')";
                    DataLayer d21 = new DataLayer();
                    d21.DmlCmd(str1);
